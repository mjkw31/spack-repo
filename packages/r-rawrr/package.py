...
class RRawrr(RPackage):
	...
	bioc = "rawrr"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/rawrr_1.10.2.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/rawrr/rawrr_1.10.2.tar.gz"]
