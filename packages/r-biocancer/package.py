...
class RBiocancer(RPackage):
	...
	bioc = "bioCancer" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/bioCancer_1.30.6.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/bioCancer/bioCancer_1.30.6.tar.gz"]

	version("1.30.6", md5="fcc20bea86327fe2896616cfc98d6241")
