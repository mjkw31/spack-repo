...
class RXeva(RPackage):
	...
	bioc = "Xeva" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Xeva_1.18.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Xeva/Xeva_1.18.0.tar.gz"]
