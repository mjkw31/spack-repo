...
class RLymphoseq(RPackage):
	...
	bioc = "LymphoSeq" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/LymphoSeq_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/LymphoSeq/LymphoSeq_1.30.0.tar.gz"]
