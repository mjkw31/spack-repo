...
class RHdf5array(RPackage):
	...
	bioc = "HDF5Array"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/HDF5Array_1.30.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/HDF5Array/HDF5Array_1.30.0.tar.gz"]

	version("1.30.0", md5="c59fcd283e0f9877f68457524b9d86bb")
