...
class RMofa2(RPackage):
	...
	bioc = "MOFA2"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/MOFA2_1.12.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/MOFA2/MOFA2_1.12.1.tar.gz"]
