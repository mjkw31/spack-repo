...
class ROrfik(RPackage):
	...
	bioc = "ORFik" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ORFik_1.22.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ORFik/ORFik_1.22.1.tar.gz"]

	version("1.22.1", md5="928aec686872c750e19951efc5c2fd65")
