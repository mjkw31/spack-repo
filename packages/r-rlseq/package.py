...
class RRlseq(RPackage):
	...
	bioc = "RLSeq" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/RLSeq_1.5.2.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/RLSeq/RLSeq_1.5.2.tar.gz"]
