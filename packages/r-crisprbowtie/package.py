...
class RCrisprbowtie(RPackage):
	...
	bioc = "crisprBowtie" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/crisprBowtie_1.6.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/crisprBowtie/crisprBowtie_1.6.0.tar.gz"]

	version("1.6.0", md5="eabea0206c16b87d8acaa65245390d30")
