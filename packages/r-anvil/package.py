...
class RAnvil(RPackage):
	...
	bioc = "AnVIL" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/AnVIL_1.14.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/AnVIL/AnVIL_1.14.1.tar.gz"]

	version("1.14.1", md5="35d6f070fcb3b27131ce3e89b0c983e7")
