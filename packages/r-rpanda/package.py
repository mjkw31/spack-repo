...
class RRpanda(RPackage):
    ...
    Perez-Lamarque & Morlon (2022) <DOI:10.1111/mec.16478> and Perez-Lamarque et al. (2022) <DOI:10.1101/2021.08.30.458192>.
	"""
	
	homepage = "https://github.com/hmorlon/PANDA"
	cran = "RPANDA" 

	version("2.2", md5="c7d06f8e47bfc736dcbc0c75840fecb7")
