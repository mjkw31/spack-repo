...
class RHilbertvisgui(RPackage):
	...
	bioc = "HilbertVisGUI"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/HilbertVisGUI_1.60.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/HilbertVisGUI/HilbertVisGUI_1.60.0.tar.gz"]
