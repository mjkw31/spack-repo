...
class RDeepbluer(RPackage):
	...
	bioc = "DeepBlueR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/DeepBlueR_1.27.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/DeepBlueR/DeepBlueR_1.27.0.tar.gz"]
