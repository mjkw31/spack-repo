...
class RMitoclone2(RPackage):
	...
	bioc = "mitoClone2"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/mitoClone2_1.8.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/mitoClone2/mitoClone2_1.8.1.tar.gz"]
