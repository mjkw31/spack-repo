...
class RPhyloprofile(RPackage):
	...
	bioc = "PhyloProfile" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/PhyloProfile_1.16.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/PhyloProfile/PhyloProfile_1.16.1.tar.gz"]

	version("1.16.1", md5="bff8322935c6b0eaa5f5db60cdb883b1")
