...
class RScpipe(RPackage):
	...
	bioc = "scPipe"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/scPipe_2.2.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/scPipe/scPipe_2.2.0.tar.gz"]
