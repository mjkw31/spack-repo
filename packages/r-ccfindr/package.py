...
class RCcfindr(RPackage):
	...
	bioc = "ccfindR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ccfindR_1.22.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ccfindR/ccfindR_1.22.0.tar.gz"]
