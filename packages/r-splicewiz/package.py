...
class RSplicewiz(RPackage):
	...
	bioc = "SpliceWiz"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/SpliceWiz_1.4.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/SpliceWiz/SpliceWiz_1.4.1.tar.gz"]
