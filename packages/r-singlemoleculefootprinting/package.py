...
class RSinglemoleculefootprinting(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/SingleMoleculeFootprinting_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/SingleMoleculeFootprinting/SingleMoleculeFootprinting_1.10.0.tar.gz"]
