...
class RRfastp(RPackage):
	...
	bioc = "Rfastp"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Rfastp_1.12.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Rfastp/Rfastp_1.12.0.tar.gz"]
