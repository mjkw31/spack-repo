...
class REsatac(RPackage):
	...
	bioc = "esATAC"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/esATAC_1.24.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/esATAC/esATAC_1.24.0.tar.gz"]

	version("1.24.0", md5="6ea63da6e75365243df878d55d6b39f9")
