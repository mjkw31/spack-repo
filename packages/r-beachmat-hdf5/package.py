...
class RBeachmatHdf5(RPackage):
	...
	bioc = "beachmat.hdf5"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/beachmat.hdf5_1.0.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/beachmat.hdf5/beachmat.hdf5_1.0.0.tar.gz"]
