...
class RCrisprverse(RPackage):
	...
	bioc = "crisprVerse" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/crisprVerse_1.4.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/crisprVerse/crisprVerse_1.4.0.tar.gz"]
