...
class RFraser(RPackage):
	...
	bioc = "FRASER" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/FRASER_1.14.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/FRASER/FRASER_1.14.1.tar.gz"]
