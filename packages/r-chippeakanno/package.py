...
class RChippeakanno(RPackage):
	...
	bioc = "ChIPpeakAnno" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ChIPpeakAnno_3.36.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ChIPpeakAnno/ChIPpeakAnno_3.36.0.tar.gz"]

	version("3.36.0", md5="d9773752fca7bd32e512d3a5b72236e1")
