...
class RGmapr(RPackage):
	...
	bioc = "gmapR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/gmapR_1.44.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/gmapR/gmapR_1.44.0.tar.gz"]

	version("1.44.0", md5="3398b4dd3f0c05c2a748f9ecb0a28c41")
