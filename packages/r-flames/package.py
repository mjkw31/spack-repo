...
class RFlames(RPackage):
	...
	bioc = "FLAMES"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/FLAMES_1.8.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/FLAMES/FLAMES_1.8.0.tar.gz"]

	version("1.8.0", md5="ecfe856c54464ffd2c27f8e10063d494")
