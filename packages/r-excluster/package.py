...
class RExcluster(RPackage):
	...
	bioc = "ExCluster" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ExCluster_1.20.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ExCluster/ExCluster_1.20.0.tar.gz"]

	version("1.20.0", md5="2f60d612945a7f431831ce690d01d042")
