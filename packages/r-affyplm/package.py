...
class RAffyplm(RPackage):
	...
	bioc = "affyPLM"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/affyPLM_1.78.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/affyPLM/affyPLM_1.78.0.tar.gz"]
