...
class RIcetea(RPackage):
	...
	bioc = "icetea" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/icetea_1.20.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/icetea/icetea_1.20.0.tar.gz"]
