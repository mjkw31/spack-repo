...
class RDeconvr(RPackage):
	...
	bioc = "deconvR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/deconvR_1.8.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/deconvR/deconvR_1.8.0.tar.gz"]
