...
class REds(RPackage):
	...
	bioc = "eds"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/eds_1.4.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/eds/eds_1.4.0.tar.gz"]
