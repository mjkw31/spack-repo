...
class RHtseqgenie(RPackage):
	...
	bioc = "HTSeqGenie" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/HTSeqGenie_4.32.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/HTSeqGenie/HTSeqGenie_4.32.0.tar.gz"]
