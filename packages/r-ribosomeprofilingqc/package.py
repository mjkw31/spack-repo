...
class RRibosomeprofilingqc(RPackage):
	...
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ribosomeProfilingQC_1.14.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ribosomeProfilingQC/ribosomeProfilingQC_1.14.0.tar.gz"]
