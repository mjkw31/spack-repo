...
class RMoonlight2r(RPackage):
	...
	bioc = "Moonlight2R"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Moonlight2R_1.0.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Moonlight2R/Moonlight2R_1.0.0.tar.gz"]

	version("1.0.0", md5="45af1bc580f9231cb2a83eae7517d3b8")
