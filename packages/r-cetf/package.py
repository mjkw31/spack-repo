...
class RCetf(RPackage):
	...
	bioc = "CeTF"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/CeTF_1.14.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/CeTF/CeTF_1.14.0.tar.gz"]
