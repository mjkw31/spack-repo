...
class RRrdp(RPackage):
	...
	bioc = "rRDP"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/rRDP_1.36.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/rRDP/rRDP_1.36.0.tar.gz"]
