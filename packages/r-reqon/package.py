...
class RReqon(RPackage):
	...
	bioc = "ReQON"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/ReQON_1.48.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/ReQON/ReQON_1.48.0.tar.gz"]
