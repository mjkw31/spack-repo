...
class RRarr(RPackage):
	...
	bioc = "Rarr"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Rarr_1.2.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Rarr/Rarr_1.2.0.tar.gz"]
