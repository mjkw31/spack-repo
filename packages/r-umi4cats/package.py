...
class RUmi4cats(RPackage):
	...
	bioc = "UMI4Cats" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/UMI4Cats_1.12.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/UMI4Cats/UMI4Cats_1.12.0.tar.gz"]
