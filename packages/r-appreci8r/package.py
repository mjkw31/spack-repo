...
class RAppreci8r(RPackage):
	...
	bioc = "appreci8R" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/appreci8R_1.20.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/appreci8R/appreci8R_1.20.1.tar.gz"]

	version("1.20.1", md5="9165459dd4a98c9645928c87b934c081")
