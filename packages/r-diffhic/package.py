...
class RDiffhic(RPackage):
	...
	bioc = "diffHic"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/diffHic_1.34.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/diffHic/diffHic_1.34.0.tar.gz"]
