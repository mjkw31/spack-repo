...
class RPing(RPackage):
	...
	bioc = "PING" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/PING_2.46.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/PING/PING_2.46.0.tar.gz"]
