...
class RBgx(RPackage):
	...
	bioc = "bgx" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/bgx_1.68.3.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/bgx/bgx_1.68.3.tar.gz"]
