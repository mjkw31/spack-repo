...
class RRbowtie2(RPackage):
	...
	bioc = "Rbowtie2"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Rbowtie2_2.8.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Rbowtie2/Rbowtie2_2.8.0.tar.gz"]

	version("2.8.0", md5="dbba503f3134fdb9c6521c060ec2d5fc", url="https://www.bioconductor.org/packages/release/bioc/src/contrib/Rbowtie2_2.8.0.tar.gz")
