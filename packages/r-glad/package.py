...
class RGlad(RPackage):
	...
	bioc = "GLAD"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/GLAD_2.66.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/GLAD/GLAD_2.66.0.tar.gz"]
