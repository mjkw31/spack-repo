...
class RMsstatsptm(RPackage):
	...
	bioc = "MSstatsPTM" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/MSstatsPTM_2.4.3.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/MSstatsPTM/MSstatsPTM_2.4.3.tar.gz"]

	version("2.4.3", md5="e01b55bda58bf377a52c05737698fbea")
