...
Models
	...
	Identifies potential data outliers and their impact on estimates and analyses. Uses the forward search approach of Atkinson and Riani, "Robust Diagnostic Regression Analysis",		  2000,<ISBN: o-387-95017-6> to prepare descriptive statistics of a dataset that is to be analyzed by stats::lm(), stats::glm(), nlme::lme() or survival::coxph().  Includes graphics functions to display the descriptive statistics.
	"""
	
	cran = "forsearch"

	version("5.0.0", md5="61be6167049eb8617f80110b368900bb")
