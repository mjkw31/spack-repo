...
class RNanomethviz(RPackage):
	...
	bioc = "NanoMethViz"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/NanoMethViz_2.8.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/NanoMethViz/NanoMethViz_2.8.1.tar.gz"]

	version("2.8.1", md5="5ddef080c0bf460814f94f28ee5f98d5")
