...
class RNormr(RPackage):
	...
	bioc = "normr"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/normr_1.28.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/normr/normr_1.28.0.tar.gz"]

	version("1.28.0", md5="06d294d5935656789cc44341eca46620")
