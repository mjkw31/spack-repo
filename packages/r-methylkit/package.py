...
class RMethylkit(RPackage):
	...
	bioc = "methylKit"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/methylKit_1.28.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/methylKit/methylKit_1.28.0.tar.gz"]
