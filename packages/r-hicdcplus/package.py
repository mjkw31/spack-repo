...
class RHicdcplus(RPackage):
	...
	bioc = "HiCDCPlus"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/HiCDCPlus_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/HiCDCPlus/HiCDCPlus_1.10.0.tar.gz"]
