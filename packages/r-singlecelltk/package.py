...
class RSinglecelltk(RPackage):
	...
	bioc = "singleCellTK" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/singleCellTK_2.12.2.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/singleCellTK/singleCellTK_2.12.2.tar.gz"]

	version("2.12.2", md5="b4d542c9326864f485b6c6e6ddb55e1e")
