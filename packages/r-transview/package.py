...
class RTransview(RPackage):
	...
	bioc = "TransView"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/TransView_1.46.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/TransView/TransView_1.46.0.tar.gz"]
