...
class RHicdoc(RPackage):
	...
	bioc = "HiCDOC"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/HiCDOC_1.4.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/HiCDOC/HiCDOC_1.4.0.tar.gz"]

	version("1.4.0", md5="334df180a7e5e2851bbf6724e8537ffd")
