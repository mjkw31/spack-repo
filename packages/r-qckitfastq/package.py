...
class RQckitfastq(RPackage):
	...
	bioc = "qckitfastq"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/qckitfastq_1.18.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/qckitfastq/qckitfastq_1.18.0.tar.gz"]
