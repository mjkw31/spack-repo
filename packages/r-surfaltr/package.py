...
class RSurfaltr(RPackage):
	...
	bioc = "surfaltr" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/surfaltr_1.8.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/surfaltr/surfaltr_1.8.0.tar.gz"]

	version("1.8.0", md5="69ea67dd32fffa5376607fa6fa5c7e9f")
