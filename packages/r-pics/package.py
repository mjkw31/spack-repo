...
class RPics(RPackage):
	...
	bioc = "PICS" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/PICS_2.46.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/PICS/PICS_2.46.0.tar.gz"]
