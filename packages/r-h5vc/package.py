...
class RH5vc(RPackage):
	...
	bioc = "h5vc"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/h5vc_2.36.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/h5vc/h5vc_2.36.0.tar.gz"]
