...
class RCogeqc(RPackage):
	...
	bioc = "cogeqc"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/cogeqc_1.6.2.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/cogeqc/cogeqc_1.6.2.tar.gz"]

	version("1.6.2", md5="8ec4050b1405b4896d55afebc10a23b5")
