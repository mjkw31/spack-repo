...
class RDapar(RPackage):
	...
	bioc = "DAPAR" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/DAPAR_1.34.5.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/DAPAR/DAPAR_1.34.5.tar.gz"]

	version("1.34.5", md5="e9299f03622ae4be4f5dc9f9cc7c8454")
