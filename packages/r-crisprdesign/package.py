...
class RCrisprdesign(RPackage):
	...
	bioc = "crisprDesign" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/crisprDesign_1.4.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/crisprDesign/crisprDesign_1.4.0.tar.gz"]
