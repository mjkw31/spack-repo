...
class RRbwa(RPackage):
	...
	bioc = "Rbwa"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/Rbwa_1.6.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/Rbwa/Rbwa_1.6.0.tar.gz"]
