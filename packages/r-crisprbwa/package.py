...
class RCrisprbwa(RPackage):
	...
	bioc = "crisprBwa" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/crisprBwa_1.6.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/crisprBwa/crisprBwa_1.6.0.tar.gz"]
