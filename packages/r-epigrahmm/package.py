...
class REpigrahmm(RPackage):
	...
	bioc = "epigraHMM"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/epigraHMM_1.10.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/epigraHMM/epigraHMM_1.10.0.tar.gz"]
