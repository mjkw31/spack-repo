...
class RQuasr(RPackage):
	...
	bioc = "QuasR"
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/QuasR_1.42.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/QuasR/QuasR_1.42.1.tar.gz"]
