...
class RExtrachips(RPackage):
	...
	bioc = "extraChIPs" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/extraChIPs_1.6.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/extraChIPs/extraChIPs_1.6.0.tar.gz"]

	version("1.6.0", md5="462672c12f16f912b7e3d4b30a07162f")

	depends_on("r-biocparallel", type=("build", "run"))
	depends_on("r@4.2:", type=("build", "run"))
	depends_on("r-genomicranges", type=("build", "run"))
	depends_on("r-ggplot2@3.4:", type=("build", "run"))
	depends_on("r-ggside@0.2.2:", type=("build", "run"))
