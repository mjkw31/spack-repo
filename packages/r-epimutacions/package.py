...
class REpimutacions(RPackage):
	...
	bioc = "epimutacions" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/epimutacions_1.6.1.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/epimutacions/epimutacions_1.6.1.tar.gz"]
