...
class RScruff(RPackage):
	...
	bioc = "scruff" 
	urls = ["https://www.bioconductor.org/packages/release/bioc/src/contrib/scruff_1.20.0.tar.gz", "https://www.bioconductor.org/packages/release/bioc/src/contrib/Archive/scruff/scruff_1.20.0.tar.gz"]
